...
@Slf4j
@RestController
@RequestMapping(PathContains.URL_CITIES)
@Tag(name = "Area Information (City/District)")
public class CitiesController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> deleteForever(@Valid @RequestBody CitiesReq idSearchReq) throws Exception {
