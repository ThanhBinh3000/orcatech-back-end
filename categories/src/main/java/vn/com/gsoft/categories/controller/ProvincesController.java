...
@Slf4j
@RestController
@RequestMapping(PathContains.URL_PROVINCES)
@Tag(name = "Area Information (Province/City)")
public class ProvincesController {
    ...
    public ResponseEntity<BaseResponse> colection(@RequestBody ProvincesReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> colectionList(@RequestBody ProvincesReq objReq) throws Exception {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody ProvincesReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody ProvincesReq objReq) throws Exception {
